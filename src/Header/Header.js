        ...
        return (
            <div className="header">
                ...
                <div className="header-intro">
                    ...
                    <h1 className="header-intro-subtitle">Full Stack Developer</h1>
                    <svg className="header-icon" xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 640 640"
